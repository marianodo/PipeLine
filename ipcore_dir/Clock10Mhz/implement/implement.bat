...
xst -ifn xst.scr
move Clock10Mhz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock10Mhz_exdes.ucf results\
...
echo 'Running map'
map -timing -pr b Clock10Mhz_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm Clock10Mhz_exdes -w routed.ncd routed.v
cd ..
